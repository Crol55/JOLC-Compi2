...
function sumarMatrices(matrix1, matrix2, auxiliar)
   
    # global auxiliar; -------------------> En mi gramatica no se puede crear "global IDENTIFICADOR" Debe ser "global IDENTIFICADOR = expresion"
    # Por lo que pondre la variable auxiliar como parametro del la funcion
